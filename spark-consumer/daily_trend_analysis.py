...
Ne işe yarar ?:
    Örneğin, bir şirket ile alakalı kelimeleri içeren tweetler bu topiğe aktarılırsa,
    bu bilgiler kullanarak, şirketin Twitter/X platformundaki günlük trend analizleri ölçülebilir.
"""
import sys
